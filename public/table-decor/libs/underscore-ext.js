...
(function() {
	...
	/**
	 * Iterates nodes and uses given stop-criterium to prevent next-level iterations.
	 * @param nodes : {id, childs: [node]}
	 * @param deeper : function(node), returns fales when not to iterate deeper
	 * @returns [node]
	 */
	UnderscoreExt.prototype.extractNodesUntil = function(nodes, deeper){
		var result = [];
		_ext.visitNodes(nodes, visitor);
	...
	/**
	 * Iterates nodes extracts leaf-nodes which are determined by the given 'deeper'-criterium.
	 * @param nodes : {id, childs: [node]}
	 * @param deeper : function(node), returns false when not to iterate deeper
	 * @returns [node]
	 */
	UnderscoreExt.prototype.extractLeafsUntil = function(nodes, deeper){
		var result = [];
		_ext.visitNodes(nodes, visitor);
